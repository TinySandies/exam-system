            ...
            <div class="col-sm-10 col-sm-offset-1">
                <div class="login-container">
                    <div class="center">
                        ...
                        <h4 class="blue" id="id-company-text"><c:if test="${not empty msg}">${sessionScope.msg}</c:if>
                        </h4>
                    </div>
                        ...
                        <div id="login-box" class="login-box visible widget-box no-border">
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <form:form id="login-form" action="/login" method="post" modelAttribute="userVo">
                                        <fieldset>

                                            <label class="block clearfix">
                                                <form:errors path="userId" cssClass="error" cssStyle="color: red;"/>
                                                <span class="block input-icon input-icon-right">
															<form:input path="userId"
                                                                        cssClass="{required, maxlength: 15}"
                                                                        placeholder="用户id"/>
...
<%--															<input type="password" class="form-control" placeholder="Password" />--%>
															<form:input path="password" placeholder="密码"
                                                                        cssClass="{required: true, maxlength: 15}"/>
