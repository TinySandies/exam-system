                    ...
                    <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                        ...
                        <li class="dropdown-content">
                            <ul class="dropdown-menu dropdown-navbar">
                                <li>
                                    <a href="#">
                                        <img src="${pageContext.request.contextPath}/static/assets/avatars/avatar.png"
                                ...
                                <li>
                                    <a href="#">
                                        <img src="${pageContext.request.contextPath}/static/assets/avatars/avatar3.png"
                                ...
                                <li>
                                    <a href="#">
                                        <img src="${pageContext.request.contextPath}/static/assets/avatars/avatar4.png"
                                ...
                                <li>
                                    <a href="#">
                                        <img src="${pageContext.request.contextPath}/static/assets/avatars/avatar2.png"
                                ...
                                <li>
                                    <a href="#">
                                        <img src="${pageContext.request.contextPath}/static/assets/avatars/avatar5.png"
...
<div class="main-container" id="main-container">
    ...
    <div id="sidebar" class="sidebar  responsive">
        ...
        <ul class="nav nav-list">
            ...
            <c:if test="${not empty role and role eq 'teacher'}">
                <li class="">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="">
                            <a href="${pageContext.request.contextPath}/teacher/exams">
                                <i class="menu-icon fa fa-caret-right"></i>
                                管理试题
                            </a>
            ...
            <c:if test="${not empty role and role eq 'student'}">
